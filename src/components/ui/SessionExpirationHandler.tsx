              ...
              <div className="items-center px-4 py-3">
                <div className="flex space-x-3">
                  <button
                    ...
                    className="px-4 py-2 bg-secondary text-secondary-foreground text-base font-medium rounded-md w-full shadow-sm hover:bg-secondary/90 focus:outline-none focus:ring-2 focus:ring-ring"
                  >
                    Continue Session
                  </button>
                  <button
