      ...
      <div className="container-responsive">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link
              href="/"
              className="text-xl font-bold hover:text-primary-foreground transition-colors duration-200"
            >
              📦 Inventory System
            </Link>
          </div>
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 rounded-lg text-primary-foreground hover:bg-secondary hover:text-secondary-foreground focus:outline-none focus:ring-2 focus:ring-ring"
