                  ...
                  <tr key={user.userId} className={`hover:bg-accent/40 transition-colors ${editingUserId === user.userId ? 'bg-primary/5' : ''}`}>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col gap-1">
                        <span className={`inline-flex items-center w-fit px-2.5 py-0.5 rounded-full text-xs font-medium ${user.role === 'Admin' || user.role === 'ADMIN' || user.role === 'ROLE_ADMIN'
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          onClick={() => handleEditClick(user)}
                          className="p-1.5 rounded-md text-muted-foreground hover:text-primary-foreground hover:bg-primary/10 transition-colors"
                          title="Edit"
                        >
