...
export const getThemeConfig = (mode: 'light' | 'dark' = 'light'): ThemeConfig => {
  return {
    mode,
...
export const cssVariables = {
  light: {
    ...
    '--typography-body-line-height': typography.sizes.body.lineHeight.toString(),
    ...
    '--typography-small-line-height': typography.sizes.small.lineHeight.toString(),
